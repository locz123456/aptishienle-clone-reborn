...
export const tryWithUsData = {
    ...
    description: "Trải nghiệm bộ Key Aptis và khóa học chất lượng từ đội ngũ giảng viên của chúng tôi",
    videos: [
      {
  ...
  export const testimonialData = {
    ...
    description: "Những phản hồi chân thực từ các học viên đã tham gia khóa học",
    testimonials: [
      {
        id: 1,
